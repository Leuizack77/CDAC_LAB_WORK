package com.demo.collections.test;

import java.util.List;
import java.util.Scanner;

import com.demo.collections.beans.Employee;
import com.demo.collections.service.EmployeeServiceImpl;
import com.demo.collections.service.EmployeeService;
...
public class TestEmployeeManagementSystem {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 5->{
				System.out.println("enetr sal for update");
