...
public class TestMyUser {
	...
	public static void main(String[] args) {
		...
		MyUser u1=new MyUser(16,"Abhishek", "abhishek@gmail.com");
		MyUser u2=new MyUser(17,"Naksh", "naksh@gmail.com");
		Product p1=new Product("Gaming Laptop",2,100000);
		Product p2=new Product("Play Station 5",1,65000);
